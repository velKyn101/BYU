...
def test_pressure_loss_from_pipe():
    assert pressure_loss_from_pipe(0.048692, 0,	0.018, 1.75) == approx(0.0)
    assert pressure_loss_from_pipe(0.048692, 200, 0, 1.75) == approx(0.0)
    assert pressure_loss_from_pipe(0.048692, 200, 0.018, 0) == approx(0.0)
...
def test_pressure_loss_from_fittings():
    assert pressure_loss_from_fittings(0, 3) == approx(0)
    assert pressure_loss_from_fittings(1.65, 0) == approx(0)
...
def test_conversion():
    assert convert_kpa_to_psi(0) == approx(0)
    assert convert_kpa_to_psi(50) == approx(7.3, abs= 0.1)
    assert convert_kpa_to_psi(150) == approx(21.7, abs= 0.1)
    assert convert_kpa_to_psi(200) == approx(29, abs=0.1)
